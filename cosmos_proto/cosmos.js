...
exports.InterfaceDescriptor = {
    ...
    fromJSON(object) {
        return {
            $type: exports.InterfaceDescriptor.$type,
...
typeRegistry_1.messageTypeRegistry.set(exports.InterfaceDescriptor.$type, exports.InterfaceDescriptor);
...
exports.ScalarDescriptor = {
    ...
    fromJSON(object) {
        return {
            $type: exports.ScalarDescriptor.$type,
            name: isSet(object.name) ? String(object.name) : "",
            description: isSet(object.description) ? String(object.description) : "",
...
typeRegistry_1.messageTypeRegistry.set(exports.ScalarDescriptor.$type, exports.ScalarDescriptor);
