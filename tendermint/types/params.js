...
exports.EvidenceParams = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        ...
        if (message.maxAgeDuration !== undefined) {
            duration_js_1.Duration.encode(message.maxAgeDuration, writer.uint32(18).fork()).join();
        }
        if (message.maxBytes !== 0n) {
            if (BigInt.asIntN(64, message.maxBytes) !== message.maxBytes) {
                throw new globalThis.Error("value provided for field message.maxBytes of type int64 too large");
    ...
    fromJSON(object) {
        return {
            ...
            maxAgeDuration: isSet(object.maxAgeDuration) ? duration_js_1.Duration.fromJSON(object.maxAgeDuration) : undefined,
            maxBytes: isSet(object.maxBytes) ? BigInt(object.maxBytes) : 0n,
        };
    },
    toJSON(message) {
        ...
        if (message.maxAgeDuration !== undefined) {
            obj.maxAgeDuration = duration_js_1.Duration.toJSON(message.maxAgeDuration);
        }
        if (message.maxBytes !== 0n) {
            obj.maxBytes = message.maxBytes.toString();
        }
