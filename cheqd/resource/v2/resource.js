...
exports.Resource = {
    ...
    fromJSON(object) {
        return { $type: exports.Resource.$type, data: isSet(object.data) ? bytesFromBase64(object.data) : new Uint8Array() };
    },
    toJSON(message) {
        const obj = {};
...
exports.ResourceWithMetadata = {
    ...
    fromJSON(object) {
        return {
            $type: exports.ResourceWithMetadata.$type,
...
typeRegistry_1.messageTypeRegistry.set(exports.ResourceWithMetadata.$type, exports.ResourceWithMetadata);
...
exports.AlternativeUri = {
    ...
    fromJSON(object) {
        return {
            $type: exports.AlternativeUri.$type,
...
typeRegistry_1.messageTypeRegistry.set(exports.AlternativeUri.$type, exports.AlternativeUri);
