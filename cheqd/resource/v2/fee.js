...
exports.FeeParams = {
    ...
    encode(message, writer = minimal_1.default.Writer.create()) {
        Object.entries(message.mediaTypes).forEach(([key, value]) => {
            exports.FeeParams_MediaTypesEntry.encode({ $type: "cheqd.resource.v2.FeeParams.MediaTypesEntry", key: key, value }, writer.uint32(10).fork()).ldelim();
        });
...
typeRegistry_1.messageTypeRegistry.set(exports.FeeParams.$type, exports.FeeParams);
...
exports.FeeParams_MediaTypesEntry = {
    ...
    fromJSON(object) {
        return {
            $type: exports.FeeParams_MediaTypesEntry.$type,
...
typeRegistry_1.messageTypeRegistry.set(exports.FeeParams_MediaTypesEntry.$type, exports.FeeParams_MediaTypesEntry);
var globalThis = (() => {
