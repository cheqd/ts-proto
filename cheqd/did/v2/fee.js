...
exports.FeeParams = {
    ...
    encode(message, writer = minimal_1.default.Writer.create()) {
        Object.entries(message.txTypes).forEach(([key, value]) => {
            exports.FeeParams_TxTypesEntry.encode({ $type: "cheqd.did.v2.FeeParams.TxTypesEntry", key: key, value }, writer.uint32(10).fork()).ldelim();
        });
...
exports.FeeParams_TxTypesEntry = {
    ...
    fromJSON(object) {
        return {
            $type: exports.FeeParams_TxTypesEntry.$type,
...
typeRegistry_1.messageTypeRegistry.set(exports.FeeParams_TxTypesEntry.$type, exports.FeeParams_TxTypesEntry);
