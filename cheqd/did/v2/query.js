...
exports.QueryClientImpl = exports.QueryServiceName = exports.QueryParamsResponse = exports.QueryParamsRequest = exports.QueryAllDidDocVersionsMetadataResponse = exports.QueryAllDidDocVersionsMetadataRequest = exports.QueryDidDocVersionResponse = exports.QueryDidDocVersionRequest = exports.QueryDidDocResponse = exports.QueryDidDocRequest = void 0;
/* eslint-disable */
...
exports.QueryParamsResponse = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        if (message.params !== undefined) {
            fee_js_1.FeeParams.encode(message.params, writer.uint32(10).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
    ...
    fromJSON(object) {
        return { params: isSet(object.params) ? fee_js_1.FeeParams.fromJSON(object.params) : undefined };
    },
    toJSON(message) {
        const obj = {};
        if (message.params !== undefined) {
