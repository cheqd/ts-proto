...
exports.MsgUpdateParams = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        ...
        if (message.params !== undefined) {
            fee_js_1.FeeParams.encode(message.params, writer.uint32(18).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 2: {
                    ...
                    message.params = fee_js_1.FeeParams.decode(reader, reader.uint32());
                    continue;
                }
            }
            if ((tag & 7) === 4 || tag === 0) {
    ...
    fromJSON(object) {
        return {
            authority: isSet(object.authority) ? globalThis.String(object.authority) : "",
            params: isSet(object.params) ? fee_js_1.FeeParams.fromJSON(object.params) : undefined,
        };
    },
    toJSON(message) {
        const obj = {};
        ...
        if (message.params !== undefined) {
            obj.params = fee_js_1.FeeParams.toJSON(message.params);
        }
        return obj;
    },
    create(base) {
    ...
    fromPartial(object) {
        ...
        message.params = (object.params !== undefined && object.params !== null)
            ? fee_js_1.FeeParams.fromPartial(object.params)
            : undefined;
        return message;
    },
};
