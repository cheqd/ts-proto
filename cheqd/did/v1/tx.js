...
exports.MsgCreateDid = {
    ...
    fromJSON(object) {
        return {
            $type: exports.MsgCreateDid.$type,
...
typeRegistry_1.messageTypeRegistry.set(exports.MsgCreateDid.$type, exports.MsgCreateDid);
...
exports.MsgUpdateDid = {
    ...
    fromJSON(object) {
        return {
            $type: exports.MsgUpdateDid.$type,
...
typeRegistry_1.messageTypeRegistry.set(exports.MsgUpdateDid.$type, exports.MsgUpdateDid);
...
exports.MsgDeactivateDid = {
    ...
    fromJSON(object) {
        return {
            $type: exports.MsgDeactivateDid.$type,
...
typeRegistry_1.messageTypeRegistry.set(exports.MsgDeactivateDid.$type, exports.MsgDeactivateDid);
...
exports.MsgDeactivateDidPayload = {
    ...
    fromJSON(object) {
        return { $type: exports.MsgDeactivateDidPayload.$type, id: isSet(object.id) ? String(object.id) : "" };
    },
    toJSON(message) {
        const obj = {};
...
typeRegistry_1.messageTypeRegistry.set(exports.MsgDeactivateDidPayload.$type, exports.MsgDeactivateDidPayload);
...
exports.MsgDeactivateDidResponse = {
    ...
    fromJSON(object) {
        return {
            $type: exports.MsgDeactivateDidResponse.$type,
...
typeRegistry_1.messageTypeRegistry.set(exports.MsgDeactivateDidResponse.$type, exports.MsgDeactivateDidResponse);
...
exports.MsgCreateDidPayload = {
    ...
    fromJSON(object) {
        return {
            $type: exports.MsgCreateDidPayload.$type,
...
typeRegistry_1.messageTypeRegistry.set(exports.MsgCreateDidPayload.$type, exports.MsgCreateDidPayload);
...
exports.MsgCreateDidResponse = {
    ...
    fromJSON(object) {
        return { $type: exports.MsgCreateDidResponse.$type, id: isSet(object.id) ? String(object.id) : "" };
    },
    toJSON(message) {
        const obj = {};
        message.id !== undefined && (obj.id = message.id);
...
typeRegistry_1.messageTypeRegistry.set(exports.MsgCreateDidResponse.$type, exports.MsgCreateDidResponse);
...
exports.MsgUpdateDidPayload = {
    ...
    fromJSON(object) {
        return {
            $type: exports.MsgUpdateDidPayload.$type,
            context: Array.isArray(object?.context) ? object.context.map((e) => String(e)) : [],
            id: isSet(object.id) ? String(object.id) : "",
            controller: Array.isArray(object?.controller) ? object.controller.map((e) => String(e)) : [],
            verificationMethod: Array.isArray(object?.verificationMethod)
...
typeRegistry_1.messageTypeRegistry.set(exports.MsgUpdateDidPayload.$type, exports.MsgUpdateDidPayload);
...
exports.MsgUpdateDidResponse = {
    ...
    fromJSON(object) {
        return { $type: exports.MsgUpdateDidResponse.$type, id: isSet(object.id) ? String(object.id) : "" };
    },
    toJSON(message) {
        const obj = {};
        message.id !== undefined && (obj.id = message.id);
...
typeRegistry_1.messageTypeRegistry.set(exports.MsgUpdateDidResponse.$type, exports.MsgUpdateDidResponse);
class MsgClientImpl {
