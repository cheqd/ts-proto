...
exports.QueryGetDidRequest = {
    ...
    fromJSON(object) {
        return { $type: exports.QueryGetDidRequest.$type, id: isSet(object.id) ? String(object.id) : "" };
    },
    toJSON(message) {
        const obj = {};
...
typeRegistry_1.messageTypeRegistry.set(exports.QueryGetDidRequest.$type, exports.QueryGetDidRequest);
...
exports.QueryGetDidResponse = {
    ...
    fromJSON(object) {
        return {
            $type: exports.QueryGetDidResponse.$type,
...
typeRegistry_1.messageTypeRegistry.set(exports.QueryGetDidResponse.$type, exports.QueryGetDidResponse);
